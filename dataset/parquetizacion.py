'''
    Con la finalidad de poder trabajar a remoto, paso los archivos .json a .parquet,
    debido a que github tiene un límite de tamaño para subir archivos. 
'''
# imports
import pandas as pd
import json
...
# Definimos rutas
ruta_steam_games_json = 'dataset/steam_games.json'
ruta_user_items_json = 'dataset/user_items.json'
ruta_user_reviews_json = 'dataset/user_reviews.json'

ruta_steam_games_parquet = 'dataset/steam_games.parquet'
ruta_user_items_parquet = 'dataset/user_items.parquet'
ruta_user_reviews_parquet = 'dataset/user_reviews.parquet'
